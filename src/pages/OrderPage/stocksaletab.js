...
import { orderListWithPx, editOrderStatusByIds, deleteOrderByIds, queryOrderDataByIdList } from "../../api/api.js";
...
const StockSaleTab = () => {
    ...
    const fetchDataAndUpdateState = async () => {
        try {
            setDataSource([]);
            setLoading(true);
            const posts = await orderListWithPx(searchParams, 1);
            if (posts.code === 200) {
